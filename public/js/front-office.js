...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getTypologies: function getTypologies() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get('http://127.0.0.1:8000/api/typologies').then(function (res) {
    ...
    getRestaurants: function getRestaurants() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get('http://127.0.0.1:8000/api/restaurants').then(function (res) {
