...
<div class="form-wrapper create-form">
    <div class="form">
        <div class="form-header">
            <h1 class="form-header-title">{{ 'Modifica il piatto '. $plate->name }}</h1>
        </div>
        <div class="form-body">
            <form enctype="multipart/form-data" method="POST" action="{{ route('admin.plates.update', $plate->id) }}">
                @csrf
                @method('PATCH')
                <div class="form-box">
                                ...
                                <label class="input" for="name">
                                    <div class="input-field">
                                        <input type="text" id="name" placeholder="Inserisci il nome del piatto"
                                            autocomplete="off" required value="{{ old('name', $plate->name) }}"
                                            name="name" />
                                    </div>
                                </label>
                ...
                <div class="form-row">
                    <div class="form-box">
                        <div class="form-box-header">
                            <h1 class="form-box-header-title">Descizione</h1>
                            <div class="form-box-header-content">
                                <label class="input" for="description">
                                    <div class="input-field">
                                        <textarea name="description" id="description"
                                            rows="5">{{ old('description', $plate->description) }}</textarea>
                                    </div>
                                </label>
                ...
                <div class="form-row">
                                ...
                                <label class="input" for="price">
                                    <div class="input-field">
                                        <input id="price" type="text" name="price"
                                            value="{{old('price', $plate->price)}}" autocomplete="off" required
                                            pattern="[0-9]+">
                                    </div>
                                </label>
                    ...
                    <div class="form-box">
                        <div class="form-box-header">
                            <h1 class="form-box-header-title">Scegli un'immagine per il Piatto</h1>
                            <div class="form-box-header-content">
                ...
                <div class="form-row">
                    <div class="form-box">
                        <div class="form-box-header">
                            <h1 class="form-box-header-title">Ingredienti</h1>
                            <div class="form-box-header-content">
                                <label class="input" for="ingredients">
                                    <div class="input-field">
                                        <textarea name="ingredients" id="ingredients"
                                            rows="5">{{ old('ingredients', $plate->ingredients) }}</textarea>
                                    </div>
                                </label>
                            ...
                            <div class="form-box-header-content">
                                <label class="custom-switch" for="visible">
                                    ...
                                    <input type="checkbox" name="visible" class="switch-input" value="1" {{
                                        old('visible', $plate->visible) ? 'checked="checked"' : '' }} id="visible" />
                ...
                <div class="form-row">
                    <div class="form-box">
                        <button type="submit" class="form-box-button site-primary-btn">{{ __('Modifica') }}</button>
                    </div>
                </div>
            </form>
        </div>
