          ...
          <div class="col-lg-4 order pt-5">
            <div class="cart-review p-3">
              ...
              <router-link
                ...
                :class="{
                  disabled: cart.length == 0 || cart.plates.length == 0,
                }"
              >
        ...
        <div class="cart-review-responsive p-3 d-flex flex-column h-100">
          ...
          <ul class="list-unstyled flex-grow-1">
            ...
            >
              ...
              <span class="fs-5 fw-bold">x{{ plate.quantity }}</span>
              <div>
                <span class="text-danger fs-3 pointer" @click="addToCart(plate)"
                  >+</span
                >
                <span
                  class="text-danger fs-3 pointer"
  ...
  methods: {
    ...
    checkForLocalstorage(item) {
      if (
        ...
        const exist = cart["plates"].find((element) => element.id === item.id);
